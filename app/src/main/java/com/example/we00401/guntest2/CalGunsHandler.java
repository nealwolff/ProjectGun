...
public class CalGunsHandler extends website {

	String globalSearchString = "";
	
    public CalGunsHandler(String Search){
//        String URL = "http://www.gunbroker.com/Auction/BrowseItems2.aspx?Keywords=" + Search +"&Cats=0";

    	globalSearchString = Search;
    	
        String URL = "http://www.calguns.net/calgunforum/forumdisplay.php?f=105&order=desc"; //FALfiles marketplace URL; THIS IS WHERE TO START
        //subsequent pages look are formated like this
        //http://www.falfiles.com/forums/forumdisplay.php?f=11&order=desc&page=2
        //http://www.calguns.net/calgunforum/forumdisplay.php?f=105&order=desc&page=2
        //                                                                  ^^^ page number
...
//        URLs[0] = "http://www.akfiles.com/forums/forumdisplay.php?f=5&order=desc"; //PAGE ONE
        URLs[0] = "http://www.calguns.net/calgunforum/forumdisplay.php?f=105&order=desc"; //PAGE ONE
        //all other pages
        for(int i = 1; i < URLs.length; i++) {
            URLs[i] = "http://www.calguns.net/calgunforum/forumdisplay.php?f=105&order=desc&page=" + (i+1);
...
//				return("http://www.akfiles.com/forums/"+temp);
				return("http://www.calguns.net/calgunforum/"+temp);
			}
		}
//		
